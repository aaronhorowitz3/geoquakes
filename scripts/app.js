      ...
      response.features.forEach(quakeInfo=>{
        ...
        function createMarker() {
          ...
          if (magnitude <= 4) {
            var marker = new google.maps.Marker({
              ...
              title: quakeTitle,
              optimized: false,
              icon: {path: google.maps.SymbolPath.CIRCLE, fillColor: 'yellow', fillOpacity: .8, strokeColor: 'yellow', scale: 3}
            })
          }
          ...
          if ((magnitude > 4) && (magnitude <= 5)) {
            var marker = new google.maps.Marker({
              ...
              title: quakeTitle,
              optimized: false,
              icon: {path: google.maps.SymbolPath.CIRCLE, fillColor: 'orange', fillOpacity: .8, strokeColor: 'orange', scale: 5}
          })
        }
        ...
        if (magnitude > 5) {
          var marker = new google.maps.Marker({
            ...
            title: quakeTitle,
            optimized: false,
            icon: {path: google.maps.SymbolPath.CIRCLE, fillColor: 'red', fillOpacity: .8, strokeColor: 'red', scale: 7}
          })
        }
      }
      createMarker();
